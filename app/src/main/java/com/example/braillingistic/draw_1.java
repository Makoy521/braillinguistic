...
public class draw_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_draw_1);

        txt = (TextView) findViewById(R.id.textdrwa1);
        a= (ImageView) findViewById(R.id.drawa); b= (ImageView) findViewById(R.id.drawb); c= (ImageView) findViewById(R.id.drawc);
        d= (ImageView) findViewById(R.id.drawd); e= (ImageView) findViewById(R.id.drawe); f= (ImageView) findViewById(R.id.drawf);
