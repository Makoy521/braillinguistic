...
public class game2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a= (ImageView) findViewById(R.id.atwo); b= (ImageView) findViewById(R.id.btwo); c= (ImageView) findViewById(R.id.ctwo);
        d= (ImageView) findViewById(R.id.dtwo); e= (ImageView) findViewById(R.id.etwo); f= (ImageView) findViewById(R.id.ftwo);

        opa = (TextView) findViewById(R.id.a); opb = (TextView) findViewById(R.id.b);
        opc = (TextView) findViewById(R.id.c); opd = (TextView) findViewById(R.id.d);
